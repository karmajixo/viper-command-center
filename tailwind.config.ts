  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        viper: {
          orange: "hsl(var(--viper-orange))",
          "orange-glow": "hsl(var(--viper-orange-glow))",
          dark: "hsl(var(--viper-dark))",
          card: "hsl(var(--viper-card))",
          border: "hsl(var(--viper-border))",
          grid: "hsl(var(--viper-grid))",
        },
        sidebar: {
